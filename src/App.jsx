        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-slate-300 mb-8 animate-fade-in">
              Data Analyst | Data Scientist | AI & Business Intelligence Specialist
            </p>
      ...
      <footer className="bg-slate-800 text-white py-12 relative z-1">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-slate-400 mb-6">Data Analyst | Data Scientist | AI & Business Intelligence Specialist</p>
